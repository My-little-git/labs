    ...
    @foreach($posts as $post)
      <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-">
          ...
          <div class="card-edit">
            <a class="card-edit_pencil" href="{{route('edit_post', 'id=' . $post->id)}}">&#9998;</a>
      ...
      <div class="collapse mt-2" id="collapseExample{{$post->id}}">
        <div class="card card-body">
          ...
          <div class="mb-3">
            <input name="name" type="text" placeholder="Имя" class="form-control" id="exampleFormControlInput1">
          </div>
          <div class="mb-3">
            <textarea name="text" class="form-control" placeholder="Комментарий" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
